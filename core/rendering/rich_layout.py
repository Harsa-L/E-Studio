...
from PySide6.QtGui import QFont, QTextLayout, QTextOption, QTextCharFormat, QColor

from core.models.rich_text_models import CharFormat, Paragraph, Overflow, TextAlignment

if TYPE_CHECKING:
    from core.rendering.render_items import TextItem
